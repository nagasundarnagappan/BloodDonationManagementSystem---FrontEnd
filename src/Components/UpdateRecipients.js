...
export default function UpdateRecipients() {
    ...
    const fetchData = async (id) => {
        let r = await axios.get("http://localhost:8080/" + id);
        let res = r.data;
        setName(res.recipientName);
        setMail(res.recipientEmail);
        setPhone(res.recipientPhone);
        setAddress(res.recipientAddress);
        setBlood(res.bloodGroup);
        console.log(res);
    }
  ...
  return (
    ...
    <form className="w-96">
        ...
        <div className="relative z-0 w-full mb-6 group">
            <input onChange={handleName} type="text" name="recipientName" id="conAddress"  className="block py-2.5 px-0 w-full text-sm text-white-1000 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-orange-500 dark:border-gray-600 dark:focus:border-orange-400 focus:outline-none focus:ring-0 focus:border-white peer" placeholder=" " value={name} required />
        ...
        <div className="relative z-0 w-full mb-6 group">
            <input onChange={handleMail} type="text" name="producerAddress" id="proAddress" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-orange-500 dark:border-gray-600 dark:focus:border-orange-400 focus:outline-none focus:ring-0 focus:border-white peer" placeholder=" " value={mail}required />
        ...
        <div className="relative z-0 w-full mb-6 group">
            <input onChange={handlePhone} type="text" name="productId" id="proId"  className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-orange-500 dark:border-gray-600 dark:focus:border-orange-400 focus:outline-none focus:ring-0 focus:border-white peer" value={phone} placeholder=" " required />
        ...
        <div className="relative z-0 w-full mb-6 group">
            <input onChange={handleAddress} type="text" name="productId" id="proId"  className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-orange-500 dark:border-gray-600 dark:focus:border-orange-400 focus:outline-none focus:ring-0 focus:border-white peer" value={address} placeholder=" " required />
        ...
        <div className="relative z-0 w-full mb-6 group">
            <input onChange={handleBlood} type="text" name="productName" id="proName" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-orange-500 dark:border-gray-600 dark:focus:border-orange-400 focus:outline-none focus:ring-0 focus:border-white peer" value={blood} placeholder=" " required />
