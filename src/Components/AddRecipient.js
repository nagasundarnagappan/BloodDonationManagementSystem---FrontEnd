...
export default function AddRecipient() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        const data = { "recipientName": name, "recipientEmail": mail, "recipientPhone": phone, "recipientAddress": address, "bloodGroup": blood}
        axios.post("http://localhost:8080/addRecipient", data);
        alert("Recipient Added Succesfully");
        navigate("/");
    }
  return (
    ...
    <form className="w-96">
        ...
        <div className="flex justify-center mt-[50px]">
            <button onClick={handleSubmit} type="button" className="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 mr-2 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-gray-800">Add Recipient</button>
